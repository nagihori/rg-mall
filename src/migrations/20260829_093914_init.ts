...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_audit_logs_action" AS ENUM('published', 'unpublished', 'archived', 'deleted', 'role_changed', 'returned_to_draft');
  CREATE TABLE "users" (
  ...
  CREATE TABLE "events" (
  	...
  	"status" "enum_events_review_status" DEFAULT 'draft',
  ...
  CREATE TABLE "_events_v" (
  	...
  	"version_status" "enum_events_review_status" DEFAULT 'draft',
  	"version_published_at" timestamp(3) with time zone,
  	"version_source_event_id" integer,
  ...
  CREATE TABLE "media" (
  	...
  	"mime_type" "enum_media_mime_type" NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "events" ADD CONSTRAINT "events_source_event_id_events_id_fk" FOREIGN KEY ("source_event_id") REFERENCES "public"."events"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_events_v" ADD CONSTRAINT "_events_v_version_source_event_id_events_id_fk" FOREIGN KEY ("version_source_event_id") REFERENCES "public"."events"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "events_source_event_idx" ON "events" USING btree ("source_event_id");
  ...
  CREATE INDEX "_events_v_version_version_source_event_idx" ON "_events_v" USING btree ("version_source_event_id");
  ...
  CREATE INDEX "audit_logs_target_user_idx" ON "audit_logs" USING btree ("target_user_id");
